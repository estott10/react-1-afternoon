...
export default class Sum extends Component {
    ...
    render(){
        return(
            ...
            <button className="confirmationButton" onClick= {()=> this.sumNums(this.state.number1, this.state.number2)}>Add</button>
...
//Given two numbers calcualte sum and display it